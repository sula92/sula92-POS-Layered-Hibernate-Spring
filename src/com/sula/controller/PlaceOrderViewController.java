...
import com.sula.dto.OrderDetailDTO;
...
import com.sula.util.PlaceOrderTM;
...
public class PlaceOrderViewController implements Initializable {
    ...
    CustomerBO customerBO= Appinitializer.customerBo;// = BOFactory.getInstance().getBO(BOTypes.CUSTOMER);
    ItemBO itemBO=Appinitializer.itemBO;//=BOFactory.getInstance().getBO(BOTypes.ITEM);
    OrderBO orderBO=Appinitializer.orderBO;//=BOFactory.getInstance().getBO(BOTypes.ORDER);
